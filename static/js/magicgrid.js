...
var masonrys = document.getElementsByTagName("img");    //masonrys라는 변수에 이 html 안에 있는 모든 이미지 태그들이 다 호출되는 것
...
// 이모든 html 태그 내에 있는 이미지에 대해서 이미지가 로드 됐을 때 이 매직그리드를 다시 포지셔닝 하라 라는 이벤트 리스너를 추구
